...
namespace Softeq.NetKit.Payments.Logger
{
    public static class LoggerConfigurationExtensions
    {
        ...
        private static void SetupSerilog(WebHostBuilderContext hostingContext, IServiceCollection serviceCollection)
        {
            ...
            {
                logger.Event("UnhandledExceptionCaughtByAppDomainUnhandledExceptionHandler").With.Message("Exception: {ExceptionObject} {IsTerminating}", args.ExceptionObject, args.IsTerminating).AsError();
            };
